...
--
-- Host: localhost:3306
-- Loomise aeg: Veebr 12, 2018 kell 10:51 EL
...
--
-- Andmebaas: `gudrunve_abs_pro`
--
CREATE DATABASE IF NOT EXISTS `gudrunve_abs_pro` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `gudrunve_abs_pro`;
...
(1, 'bdfsgbhetgvdgvfergfegfdswvweaf', 'fewfrwefredsafserf3ewrfds', 'TIITEL', 0, 0, 1, 0, 0, '0000-00-00 00:00:00', 0, ''),
(2, 'aaaaaaaaaaaaaaa', 'bbbbbbbbbbbb', 'AAA', 0, 0, 1, 0, 0, '0000-00-00 00:00:00', 1, '');
...
(1, 'admin', '7ec5c3ed7c6811bd26c45c7b4d601f7d', 'Admin', 'Istraator', 'admin@localhost', 1, 2, '2018-02-12 00:00:00', '2018-02-12 08:40:45'),
(2, 'tava', '878e9103c2f839fab4027a12b1b33e8c', 'Tava', 'Kasutaja', 'user@localhost', 1, 1, '2018-02-12 00:00:00', '2018-02-12 08:41:41');
...
--
ALTER TABLE `content`
  MODIFY `content_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
